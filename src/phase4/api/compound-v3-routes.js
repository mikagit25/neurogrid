...
router.get('/markets', async (req, res) => {
    try {
        ...
        const markets = {};
        if (compoundManager.config.market_configs) {
            for (const [market, config] of Object.entries(compoundManager.config.market_configs)) {
                markets[market] = {
                    market,
    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                projections,
                market_info: compoundManager.config.market_configs[market]
            },
