...
class ResourceAllocator extends EventEmitter {
  ...
  selectBestNode(suitableNodes, _requirements) {
  ...
  identifyFragmentedNodes() {
    ...
    for (const [nodeId, _resources] of this.nodeResources.entries()) {
  ...
  updateResourceMetrics() {
    ...
    for (const [_nodeId, resources] of this.nodeResources.entries()) {
