...
(
  ...
  last_login_at TIMESTAMP
    ...
    (
        ...
        -- offline, online, busy, maintenance
        is_verified BOOLEAN DEFAULT false,
        price_per_hour DECIMAL(10, 6),
        -- NEURO tokens per hour
  ...
  completed_at TIMESTAMP
                ...
                (
                    ...
                    -- payment, reward, stake, unstake, fee
...
$$ language 'plpgsql';
    ...
    FOR EACH ROW
                                ...
                                CREATE TRIGGER update_gpu_nodes_updated_at BEFORE
                                UPDATE ON gpu_nodes
    FOR EACH ROW
                                EXECUTE FUNCTION update_updated_at_column
                                ();

                                CREATE TRIGGER update_ai_models_updated_at BEFORE
                                UPDATE ON ai_models
    FOR EACH ROW
                                EXECUTE FUNCTION update_updated_at_column
                                ();

                                CREATE TRIGGER update_ai_tasks_updated_at BEFORE
                                UPDATE ON ai_tasks
    FOR EACH ROW
                                EXECUTE FUNCTION update_updated_at_column
                                ();

                                CREATE TRIGGER update_user_balances_updated_at BEFORE
                                UPDATE ON user_balances
    FOR EACH ROW
                                EXECUTE FUNCTION update_updated_at_column
                                ();